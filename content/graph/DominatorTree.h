 ...
 * Author: ivan100sic
 * License: CC0
 * Source: library-checker judge
 * Description: Calculates the dominator tree of a directed graph with given source.
 * ans[i] is the immediate dominator of vertex i, ans[i] = i means vertex unreachable or source
 * Time: $O(N \alpha)$
 * Status: tested on library-checker judge
 */
